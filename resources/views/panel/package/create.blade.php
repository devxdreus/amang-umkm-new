        ...
        <div class="card-body">
          ...
          <form action="{{ route('panel.packages.store') }}" method="post">
            ...
            <div class="mb-3">
              ...
              <textarea class="form-control" id="benefit" placeholder="Benefit paket" name="benefit" rows="3">{{ old('benefit') }}</textarea>
            ...
            <div class="mb-3">
              ...
              <textarea class="form-control" id="description" placeholder="Deskripsi paket" name="description" rows="4">{{ old('description') }}</textarea>
