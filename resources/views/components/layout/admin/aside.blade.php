        ...
        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
          ...
          <div class="menu-sub menu-sub-accordion">
            <div class="menu-item">
              ...
              <a class="menu-link" href="{{ url('seller/pesanan') }}">
                <span class="menu-bullet">
                  <span class="bullet bullet-dot"></span>
                </span>
                <span class="menu-title">Kelola Pesanan</span>
              </a>
              <a class="menu-link" href="{{ url('seller/pesanan/riwayat') }}">
                <span class="menu-bullet">
                  <span class="bullet bullet-dot"></span>
                </span>
          ...
          <div class="menu-sub menu-sub-accordion">
            <div class="menu-item">
              <a class="menu-link" href="../../demo10/dist/index.html">
                ...
                <span class="menu-title">Pembayaran Saya</span>
              </a>
            </div>
            <div class="menu-item">
              <a class="menu-link" href="../../demo10/dist/index.html">
    ...
    <div class="d-flex flex-stack">
      ...
      <div class="d-flex align-items-center">
        ...
        <div class="symbol symbol-circle symbol-40px">
          <img src="{{ asset('media/avatars/300-1.jpg') }}" alt="photo" />
        </div>
        <!--end::Avatar-->
        <!--begin::User info-->
        <div class="ms-2">
      ...
      <!--begin::User menu-->
      <div class="ms-1">
        <div class="btn btn-sm btn-icon btn-active-color-primary position-relative me-n2" data-kt-menu-trigger="click"
