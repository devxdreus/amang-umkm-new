<div id="kt_header" class="header header-bg">
  ...
  <div class="container-fluid">
    ...
    <div class="header-brand me-5">
      ...
      <!--begin::Logo-->
      <a href="/">
        <img alt="Logo" src="{{ asset('media/logos/umkm-2-1.png') }}" class="h-25 h-lg-50px d-none d-md-block" />
        <img alt="Logo" src="{{ asset('media/logos/umkm-1.png') }}" class="h-25 d-block d-md-none" />
      </a>
      <!--end::Logo-->
    </div>
    <!--end::Brand-->
    ...
    <div class="topbar d-flex align-items-stretch">
          ...
          <div data-kt-search-element="content"
            ...
            <form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
              ...
              <div class="d-flex justify-content-end">
                ...
                <a href="../../demo10/dist/pages/search/horizontal.html" class="btn btn-sm fw-bolder btn-primary"
            ...
            <div class="menu-content px-5">
              <label class="form-check form-switch form-check-custom form-check-solid pulse pulse-success"
                ...
                <input class="form-check-input w-30px h-20px" type="checkbox" value="1" name="mode"
                  id="kt_user_menu_dark_mode_toggle" data-kt-url="../../demo10/dist/index.html" />
      ...
      <div class="d-flex align-items-center me-2 me-lg-4">
        <a href="#" class="btn btn-success border-0 px-3 px-lg-6" data-bs-toggle="modal"
          data-bs-target="#kt_modal_create_campaign">Shop</a>
      </div>
      <!--end::Item-->
    </div>
    <!--end::Topbar-->
